...
export class SpotifyFindService implements FindService {
    ...
    authenticate(): void {
        ...
        const redirectUri = encodeURIComponent("https://lively-sky-0c3feb303.azurestaticapps.net/");
        ...
        cookies.set(this.authStateName, state, { expires: new Date(Date.now() + (minutesAllowedToLogIn * 60 * 1000)), secure: true });
